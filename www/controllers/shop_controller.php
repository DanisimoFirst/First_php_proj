...
if( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' ) {
    ...
    if( empty( $view_data[ 'add_error' ] ) ) {
        ...
        $page = $_GET['page'] ?? 1 ;        //  $page  1      2      3      4       
        $perpage = 4 ;                      //  nums   1-4    5-8    9-12   13,14,15 (всего 15)
        $skip = ( $page - 1 ) * $perpage ;  //  $skip  0      4      8      12
        ...
        $sql = "SELECT * FROM Products p    ORDER BY p.add_dt DESC     LIMIT $skip, $perpage" ;
        try {
            $view_data[ 'products' ] = 
